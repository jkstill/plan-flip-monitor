...
-- cursors-invalidated-sigmoid.sql
-- show any cursors with invalidatsions that have invalidataion sigmoid >= 0.95
...
ttitle off
set head on verify off pause off
